public static class Queries
{
    ...
    //     select * from openquery (terry, '
    //         select OrgR, OrgName from ReportingOrg
    //         where Active = 1
    //         order by OrgR
    //     ')";
...
";
    ...
    public static string StudentsForCourse(string[] crns, string term)
    {
        ...
        string query = $@"select * from openquery (sis, '
                        ...
                        and sfrstcr_term_code = 201903
                        and sfrstcr_crn in (92669,77933,77934,77935,87027,69480,77199)
